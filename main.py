...
rens_ungrouped  = [x for page in rens_grouped for order in list(page.values()) for x in order]
...
rens_type_ids = [x for order_set in rens_grouped for x in list(order_set.keys())]
